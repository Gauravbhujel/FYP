...
urlpatterns = [
    ...
    path('admin/dashboard/activities/', views.admin_recent_activities, name='admin_recent_activities'),
    path('admin/dashboard/reports/', views.admin_reports_stats, name='admin_reports_stats'),
    ...
    path('vendor/orders/update-status/', views.vendor_update_order_status, name='vendor_update_order_status'),
