      ...
      <div className="w-full space-y-8 animate-fade-in pb-12">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-[10px] font-black text-gray-400 mt-2 uppercase tracking-[3px] leading-none">Global Management Overview</p>
          </div>
          
          <Link to="/admin/reports">
            <button className="h-11 px-8 bg-gray-900 text-white font-black text-[10px] rounded uppercase tracking-[0.2em] flex items-center gap-3 transition-all hover:bg-black hover:scale-[1.02] active:scale-95 shadow-lg border-none cursor-pointer">
              <PieChartIcon size={16} /> View Detailed Reports
            </button>
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8">
                <div className="bg-white border border-gray-300 rounded-lg p-8 shadow-sm">
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-100">
                        <Link to="/admin/vendors" className="text-[10px] font-black text-accent uppercase tracking-widest hover:underline flex items-center gap-2">
                            Manage All Vendors <ArrowRightIcon size={12} />
                        </Link>
                    </div>
                </div>
            </div>
            ...
            <div className="lg:col-span-4 flex flex-col gap-8">
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 text-white relative overflow-hidden group">
                     ...
                     <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-2">Platform Health</p>
                     <h3 className="text-2xl font-black text-white mb-4 tracking-tighter uppercase">Optimal 99.9%</h3>
                     ...
                     <p className="text-[10px] font-black text-gray-400 leading-relaxed uppercase tracking-widest">System performing within normal range.</p>
                </div>
            </div>
        </div>
      </div>
